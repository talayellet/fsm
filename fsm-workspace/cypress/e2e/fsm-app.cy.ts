...
describe('FSM library E2E Tests', () => {
  ...
  it('should update the current state on next state click', () => {
    ...
    cy.get('li.active-state', TIMEOUT).as('active-node1');
